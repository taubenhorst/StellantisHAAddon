...
| `language` | Language of the entity names (15 languages from the upstream integration, English for anything untranslated) and of the ingress page (German or English) |
